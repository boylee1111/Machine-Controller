...
- (UIImage *) thumbWithColor:(UIColor*)color {
    ...
    CGSize size = CGSizeMake(100.0*scale, 44.0*scale);
    CGFloat radius = 20.0*scale;
    ...
    [color setFill];
    [[[UIColor colorWithRed:82.0/255.0 green:82.0/255.0 blue:82.0/255.0 alpha:1.0] colorWithAlphaComponent:1.0] setStroke];
    
    CGFloat radiusp = radius+1.5;
    CGFloat wid1 = size.width-1.5;
    CGFloat hei1 = size.height-1.5;
    CGFloat wid2 = size.width-radiusp;
    CGFloat hei2 = size.height-radiusp;
    
	// Path
    CGContextMoveToPoint(context, 1.5, radiusp);
    CGContextAddArcToPoint(context, 1.5, 1.5, radiusp, 1.5, radius);
    CGContextAddLineToPoint(context, wid2, 1.5);
    CGContextAddArcToPoint(context, wid1, 1.5, wid1, radiusp, radius);
    ...
    CGContextAddArcToPoint(context, 1.5, hei1, 1.5, hei2, radius);
